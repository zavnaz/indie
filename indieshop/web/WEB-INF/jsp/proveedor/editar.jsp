<%-- 
    Document   : editar
    Created on : Dec 13, 2020, 10:12:54 AM
    Author     : mario
--%>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">                    
                    <div class="container tm-site-header-container tm-site-header-col">
                        <div class=" col-md-5">
                <f:form action="${action}" method="POST" modelAttribute="proveedor">

                    <div class="form-group">
                        <label for="codigoProv">Codigo Proveedor</label>
                        <div class="input-group">
                            <f:input path="idProv" cssClass="form-control" readonly="true"/>
                    ...
                    <div class="form-group">
                        <label for="numVentas">Ventas</label>
                        <div class="input-group">
                            <f:input path="numVenProv" cssClass="form-control" readonly="true"/>
                            <span class="input-group-addon"><span class="glyphicon glyphiconasterisk"></span></span>
                        </div>
                    </div>
