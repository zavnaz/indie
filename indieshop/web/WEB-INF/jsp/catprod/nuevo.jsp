<%-- 
    Document   : nuevo
    Created on : 12-13-2020, 12:12:15 AM
    Author     : roco_
--%>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">                    
                    <div class="container tm-site-header-container tm-site-header-col">
                        <div class=" col-md-5">
                <f:form action="crear" method="POST" modelAttribute="catprod">

                    <div class="form-group">
                        <label for="codigoClie">Codigo Categoria Productos</label>
                        <div class="input-group">
                            <f:input path="idCat" cssClass="form-control"/>
                            <span class="input-group-addon"><span class="glyphicon glyphiconasterisk"></span></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="codigoUsu">Nombre Categoria Productos</label>
                        <div class="input-group">
                             <f:input path="nomCat" cssClass="form-control"/>
                            <span class="input-group-addon"><span class="glyphicon glyphiconasterisk"></span></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <f:input path="desCat" cssClass="form-control"/>
                            <span class="input-group-addon"><span class="glyphicon glyphiconasterisk"></span></span>
                        </div>
                    </div>
