<%-- 
    Document   : pop
    Created on : Dec 13, 2020, 12:24:09 AM
    Author     : mario
--%>
...
-->
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/pop/css/bootstrap.min.css">                                  <!-- https://getbootstrap.com/ -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/pop/fontawesome/css/fontawesome-all.min.css">                <!-- https://fontawesome.com/ -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/pop/slick/slick.css"/>                       <!-- http://kenwheeler.github.io/slick/ -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/pop/slick/slick-theme.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/pop/css/tooplate-style.css">                               <!-- Templatemo style -->
...
<body>
                                ...
                                <div class="gridpop__item" id="home-link">
                                    <div class="product">
                                        ...
                                        <div class="product__description">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    <img src="${pageContext.request.contextPath}/assets/pop/img/welcome-1.jpg" class="img-fluid mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                    ...
                                                    <img src="${pageContext.request.contextPath}/assets/pop/img/welcome-2.jpg" class="img-fluid">
                                                </div>                                        
                                            </div>
                                            ...
                                            <div class="p-sm-4 p-2">
                                                ...
                                                <div class="row tm-reverse-sm">
                                                    ...
                                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-lg-0 mb-sm-4 mb-4">
                                                        <img src="${pageContext.request.contextPath}/assets/pop/img/team.jpg" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="p-sm-4 p-2 tm-img-container">
                                                            <div class="tm-img-slider" id="tmImgSlider">
                                                              <img src="${pageContext.request.contextPath}/assets/pop/img/gallery-img-01-tn.jpg" alt="Image" class="tm-slider-img">
                                                              <img src="${pageContext.request.contextPath}/assets/pop/img/gallery-img-02-tn.jpg" alt="Image" class="tm-slider-img">
                                                              <img src="${pageContext.request.contextPath}/assets/pop/img/gallery-img-03-tn.jpg" alt="Image" class="tm-slider-img">
                                                              <img src="${pageContext.request.contextPath}/assets/pop/img/gallery-img-04-tn.jpg" alt="Image" class="tm-slider-img">
                                                              <img src="${pageContext.request.contextPath}/assets/pop/img/gallery-img-05-tn.jpg" alt="Image" class="tm-slider-img">
                                                              <img src="${pageContext.request.contextPath}/assets/pop/img/gallery-img-06-tn.jpg" alt="Image" class="tm-slider-img">
                                                            </div>
                                                        </div>  
                                                    </div>
                                                </div>
    ...
    <!-- load JS -->
    <script src="${pageContext.request.contextPath}/assets/pop/js/jquery-3.2.1.slim.min.js"></script>         <!-- https://jquery.com/ -->    
    <script src="${pageContext.request.contextPath}/assets/pop/slick/slick.min.js"></script>                  <!-- http://kenwheeler.github.io/slick/ -->  
    <script src="${pageContext.request.contextPath}/assets/pop/js/anime.min.js"></script>                     <!-- http://animejs.com/ -->
    <script src="${pageContext.request.contextPath}/assets/pop/js/main.js"></script>  
    <script>      
