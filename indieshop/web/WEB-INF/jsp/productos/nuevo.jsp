<%-- 
    Document   : nuevo
    Created on : Dec 13, 2020, 7:38:00 PM
    Author     : mario
--%>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">                    
                    <div class="container tm-site-header-container tm-site-header-col">
                        <div class=" col-md-5">
                <f:form action="crear" method="POST" modelAttribute="producto">

                    <div class="form-group">
                        <label for="codigoProv">Codigo</label>
                        <div class="input-group">
                            <f:input path="idPro" cssClass="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-group">
                        <label for="imgPro">Existencias</label>
                        <div class="input-group">
                             <f:input path="exiPro" cssClass="form-control"/>
                            <span class="input-group-addon"><span class="glyphicon glyphiconasterisk"></span></span>
                        </div>
                    </div>
