<%-- 
    Document   : registro
    Created on : Dec 15, 2020, 4:19:31 PM
    Author     : mario
--%>
            ...
            <div class="tm-body">
                ...
                <div class="tm-main-content">                    
                    <div class="container tm-site-header-container tm-site-header-col">
                        <div class=" col-md-5">
                <f:form action="crearr" method="POST" modelAttribute="usuarios">

                    <div class="form-group">
                        <label for="codigoClie">Codigo</label>
                        <div class="input-group">
                            <f:input path="idUs" cssClass="form-control"/>
